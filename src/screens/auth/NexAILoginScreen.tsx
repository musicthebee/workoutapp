      ...
      <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
        ...
        >
          ...
          >
            ...
            {/* Form Card */}
            <Animated.View style={[styles.formContainer, formStyle, errorStyle]}>
              <AuthFormCard delay={400}>
                ...
                >
                  <AuthLink onPress={onForgotPassword!}>Forgot password?</AuthLink>
                </Animated.View>
                ...
                <Animated.View entering={FadeInUp.delay(600).springify()}>
                  ...
                  >
                    {isPending && <ActivityIndicator color="#FFFFFF" size="small" />}
                  </BigButton>
                </Animated.View>

                {/* Error Display */}
                {authError && (
                  <AuthError message={authError?.message || 'Invalid email or password'} />
                )}
              </AuthFormCard>
            </Animated.View>
            ...
            >
              ...
              <AuthLink onPress={onRegister!}>Sign Up</AuthLink>
            </Animated.View>
          </ScrollView>
        </KeyboardAvoidingView>
      </TouchableWithoutFeedback>
