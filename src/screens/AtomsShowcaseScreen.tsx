    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: theme.colors.background }}>
      ...
      >
        ...
        <GlassBase variant="light" style={{ padding: theme.spacing.lg }}>
          ...
          <TextBase variant="body_medium" color="primary">
            Primary Color
          </TextBase>
          <TextBase variant="body_medium" color="secondary">
            Secondary Color
          </TextBase>
          <TextBase variant="body_medium" color="tertiary">
            Tertiary Color
          </TextBase>
          <TextBase variant="body_medium" color="error">
            Error Color
          </TextBase>
          <TextBase variant="body_medium" color="success">
            Success Color
          </TextBase>
          <TextBase variant="body_medium" color="warning">
            Warning Color
          </TextBase>
          <TextBase variant="body_medium" color="info">
            Info Color
          </TextBase>
        </GlassBase>
        ...
        <Flex gap="md">
          ...
          >
            <TextBase variant="button_large" color="primary">
              Ghost Button
            </TextBase>
          </ButtonBase>
        ...
        <Flex gap="md">
          ...
          <Flex gap="xs">
            <TextBase variant="body_small" color="error">
              Input with Error
            </TextBase>
            <InputBase
              variant="default"
        ...
        <GlassBase variant="light" style={{ padding: theme.spacing.lg }}>
          ...
          <Grid columns={2} gap="md">
            <GlassBase
              variant="medium"
              style={{ padding: theme.spacing.md, height: theme.sizes.touchTargets.huge }}
            >
        ...
        <GlassBase variant="light" style={{ padding: theme.spacing.lg }}>
          {(['xxxs', 'xxs', 'xs', 'sm', 'md', 'lg', 'xl', 'xxl', 'xxxl'] as const).map(size => (
            <Flex key={size} direction="row" align="center" gap="md">
              <TextBase variant="caption" style={{ width: 40 }}>
                {size}:
              </TextBase>
              <View
                style={{
